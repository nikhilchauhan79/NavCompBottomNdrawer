...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        to_settings_fragment.setOnClickListener {
            view.findNavController().navigate(R.id.action_homeFragment_to_settingsFragment)

        }

        to_profile_fragment.setOnClickListener {
            view.findNavController().navigate(R.id.action_homeFragment_to_profileFragment)

        }

        to_notification_fragment.setOnClickListener {
            view.findNavController().navigate(R.id.action_homeFragment_to_notificationFragment)

        }

        to_gallery_fragment.setOnClickListener {
            view.findNavController().navigate(R.id.action_homeFragment_to_galleryFragment)
